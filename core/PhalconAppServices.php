...
class PhalconAppServices
{
    ...
    public function __construct($mod = null, $conf = null)
    {
        if(is_null($mod) || is_null($conf))
            throw new Exception("phalconAppServices::__construct -> 'module' and 'config' parameters are required.");
    ...
    {
        if($adapter != 'mysql')
            throw new Exception("PhalconAppServices::setDatabaseService -> this adapter has not implemented yet :(");
